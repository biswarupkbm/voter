							...
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a href="javascript:void(0);"
										...
										<img class="me-2 rounded-pill" src="asset/assets/img/flags/us.png" alt="Img"
											height="22" width="22"> English
									</a>
									<a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">
										<img class="me-2 rounded-pill" src="asset/assets/img/flags/fr.png" alt="Img"
											height="22" width="22"> French
									</a>
									<a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">
										<img class="me-2 rounded-pill" src="asset/assets/img/flags/es.png" alt="Img"
											height="22" width="22"> Spanish
									</a>
									<a href="javascript:void(0);" class="dropdown-item d-flex align-items-center">
										<img class="me-2 rounded-pill" src="asset/assets/img/flags/de.png" alt="Img"
					...
					<ul>
						<li>
							<a href="javascript:void(0);"
								...
								<img src="asset/assets/img/icons/global-img.svg" class="avatar avatar-md img-fluid rounded"
									alt="Profile">
								...
								<div class="event-wrapper event-scroll">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div class="avatar-list-stacked avatar-group-sm">
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-01.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-07.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-02.jpg" class="rounded-circle"
														alt="img">
												</span>
											</div>
										</div>
									...
									<div class="border-start border-info border-3 shadow-sm p-3 mb-3">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div class="avatar-list-stacked avatar-group-sm">
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-05.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-06.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-07.jpg" class="rounded-circle"
									...
									<div class="border-start border-danger border-3 shadow-sm p-3 mb-3">
										...
										<div class="d-flex align-items-center justify-content-between">
											...
											<div class="avatar-list-stacked avatar-group-sm">
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-11.jpg" class="rounded-circle"
														alt="img">
												</span>
												<span class="avatar border-0">
													<img src="asset/assets/img/parents/parent-13.jpg" class="rounded-circle"
														alt="img">
												</span>
											</div>
										</div>
									...
									<div class="owl-carousel student-slider h-100">
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="asset/assets/img/performer/performer-01.png" alt="img">
											</div>
										</div>
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="asset/assets/img/performer/performer-02.png" alt="img">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="owl-carousel teacher-slider h-100">
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="asset/assets/img/performer/student-performer-01.png" alt="img">
											</div>
										</div>
										<div class="item h-100">
											<div class="d-flex justify-content-between flex-column h-100">
												...
												<img src="asset/assets/img/performer/student-performer-02.png" alt="img">
											</div>
										</div>
									</div>
								</div>
					...
					<div class="col-xxl-4 col-md-12 d-flex flex-column">
						...
						<div class="card flex-fill">
							<div class="card-header d-flex align-items-center justify-content-between">
								...
								<a href="#" class="link-primary fw-medium" data-bs-toggle="modal"
							...
							<div class="card-body">
								<div class="d-flex align-items-center rounded border p-3 mb-3">
									<span class="avatar avatar-md flex-shrink-0 border rounded me-2">
										<img src="asset/assets/img/teachers/teacher-01.jpg" class="rounded" alt="Profile">
									</span>
									<div class="w-100">
								...
								<div class="d-flex align-items-center rounded border p-3 mb-0">
									<span class="avatar avatar-md flex-shrink-0 border rounded me-2">
										<img src="asset/assets/img/teachers/teacher-03.jpg" class="rounded" alt="Profile">
									</span>
									<div class="w-100">
										<p class="mb-1">Oct 2024</p>
										<div class="progress progress-xs  flex-grow-1 mb-1">
										...
										<div class="d-flex align-items-center justify-content-between mb-3">
											<div class="d-flex align-items-center overflow-hidden me-2">
												<a href="javascript:void(0);"
													...
													<img src="asset/assets/img/profiles/avatar-14.jpg" alt="student">
												</a>
											...
											<div class="d-flex align-items-center">
												<a href="#" class="avatar avatar-xs p-0 btn btn-success me-1"><i
														class="ti ti-checks"></i></a>
												<a href="#" class="avatar avatar-xs p-0 btn btn-danger"><i
														class="ti ti-x"></i></a>
											</div>
										</div>
									...
									<div class="card-body p-3">
										<div class="d-flex align-items-center justify-content-between mb-3">
											<div class="d-flex align-items-center overflow-hidden me-2">
												<a href="javascript:void(0);"
													class="avatar avatar-lg flex-shrink-0 me-2">
													<img src="asset/assets/img/profiles/avatar-19.jpg" alt="student">
												</a>
												<div class="overflow-hidden">
													<h6 class="mb-1 text-truncate "><a
							...
							<div class="card-body">
								<div class="d-flex align-items-center overflow-hidden p-3 mb-3 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="asset/assets/img/students/student-09.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
								...
								<div class="d-flex align-items-center overflow-hidden p-3 mb-3 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="asset/assets/img/students/student-12.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
								...
								<div class="d-flex align-items-center overflow-hidden p-3 mb-3 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="asset/assets/img/students/student-11.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
								...
								<div class="d-flex align-items-center overflow-hidden p-3 mb-0 border rounded">
									<span class="avatar avatar-lg flex-shrink-0 rounded me-2">
										<img src="asset/assets/img/students/student-10.jpg" alt="student">
									</span>
									<div class="overflow-hidden">
